...
Private workspace + config for **Flyn** — Ryan's CEO of Mac Mini 4C. Flyn owns the machine end-to-end: strategy, orchestration, execution, interactive turns. Fully autonomous within Ryan's approval gates. Spawns sub-agents for specialist work.
...
Flyn owns 4C end-to-end. Sub-agents are tools Flyn spawns for specialist work. Everything respects Ryan's approval gates (`workspace/AGENTS.md`).
